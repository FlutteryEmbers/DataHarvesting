...
class PHindsightExperienceReplayMemory(object):
    """
    ...
    def __init__(self, memory_size, input_dims):
        super(PHindsightExperienceReplayMemory, self).__init__()
        ...
        self.weights = np.zeros(memory_size, dtype=np.float32)

    def add_experience(self, state, action, reward, next_state, done, goal, w):
        """
