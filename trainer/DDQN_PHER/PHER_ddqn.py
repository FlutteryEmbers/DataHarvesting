...
from trainer.DDQN_PHER.Prioritized_HERBuffer import PHindsightExperienceReplayMemory as ReplayBuffer
...
class DDQN(object):
    ...
    def store_transition(self, s, a, r, s_, done, goal, w):
        self.memory.add_experience(s, a, r, s_, done, goal, w)
