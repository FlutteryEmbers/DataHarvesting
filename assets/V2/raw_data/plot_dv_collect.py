...
file_2 = 'MA_PPO_Raw/results/config_5/seed_10/Aug18-21_02-ppo_stationary_vanilla/best_case/dv_collected.pickle'
file_1 = 'DDQN_Optimal/config_5/seed_10/ddqn_ma/best_case/dv_collected.pickle'
...
for i in range(4):
    ...
    axs[0].plot(t, data[i], label="target {}".format(i))
...
for i in range(4):
    # self.num_plots += 1
    # plot_curve(t, data[i], self.filename(type=type, turrent=i), self.num_plots)
    axs[1].plot(t, data[i], label="target {}".format(i))
...
fig.savefig('{}.png'.format('ddqn_vs_ppo_1'), bbox_inches='tight', pad_inches=0.1, format='png', dpi=300)
fig.savefig('{}.eps'.format('ddqn_vs_ppo_1'), bbox_inches='tight', pad_inches=0.1, format='eps', dpi=300)