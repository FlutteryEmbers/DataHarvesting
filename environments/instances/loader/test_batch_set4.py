...
class Instances:
    def __init__(self) -> None:
        ...
        self.phi_model_name = 'configs/config_trans_model_2_D_1.yaml'
        self.x_limit = 10
        self.y_limit = 10
        self.tower_location = [[7, 2], [1, 8], [3, 6]]
        self.time_scale = 1
...
# env_list.add_mission(start_at=[0, 0], arrival_at=[9, 9], dv_required=[4, 5, 6])
env_list.add_mission(start_at=[0, 0], arrival_at=[2, 5], dv_required=[4, 2.5, 1.3]) ## Different arrival point
