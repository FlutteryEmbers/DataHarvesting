...
DR_Environment = Agent(task = task2)

DR_Environment_Continuous = Agent(task = task2, action_type='Continuous')
DR_Environment_Eval_Continuous = Agent(task = task2, action_type='Continuous')