import os
from turtle import forward ## handle model checkpoints
import torch as T
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, max_action, fc1_dims=256, fc2_dims=256, n_actions=2, name='actor', chkpt_dir='model/sac') -> None:
        ...
        ## reparameter: prevent taken gradient respect to 0
        self.reparam_noise = 1e-6

        self.fc1 = nn.Linear(*self.input_dims, self.fc1_dims)
        self.fc2 = nn.Linear(self.fc1_dims, fc2_dims)

        ## mean of the distribution of the policy
        self.mu = nn.Linear(self.fc2_dims, self.n_actions)

        ## std of the distribution of the policy
    ...
    def forward(self, state):
        ...
        ## clamp the sigma, don't want the distribution to be very broad
